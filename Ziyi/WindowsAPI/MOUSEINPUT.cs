...
namespace WindowsAPI
{
    ...
    public struct MOUSEINPUT
    {
        ...
        /// the value of the dwFlags member. Absolute data is specified as the y coordinate of the mouse; relative data is 
        /// specified as the number of pixels moved. 
        /// </summary>
        public int dy;
        /// <summary>
        ...
        ///example, if the left mouse button is pressed and held down, MOUSEEVENTF_LEFTDOWN is set when the left button is first 
